...
def parse():
	...
	arg.add_argument('-f', '--file', help='Pickle file input containing predicted edges', required=True)
	arg.add_argument('-g', '--graph', help='Graph file to add predictions to.', required=True)
	arg.add_argument('-o', '--output', help='File path/name of new graph with added predictions.', required=True)
